...
SSL_MACHENISM="PLAIN"
API_KEY = "FM357MJTX4HL3GNF" #os.getenv('API_KEY',None)
ENDPOINT_SCHEMA_URL  = os.getenv('ENDPOINT_SCHEMA_URL',None)
API_SECRET_KEY = "qaOBUEI1p3bhJgOCzkN9ilJdPYMEnXmGj+Ns5hNnbE39x34NlzTKEOPe9nupk+6s--------"#os.getenv('API_SECRET_KEY',None)
